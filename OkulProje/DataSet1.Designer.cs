...
FROM            Tbl_Kulupler INNER JOIN
                         Tbl_Ogrenciler ON Tbl_Kulupler.Kulupid = Tbl_Ogrenciler.OgrenciKulup
WHERE        (Tbl_Ogrenciler.OgrenciAd = @p1)";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@p1", global::System.Data.SqlDbType.VarChar, 30, global::System.Data.ParameterDirection.Input, 0, 0, "OgrenciAd", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[2] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[2].Connection = this.Connection;
            ...
            this._commandCollection[3] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[3].Connection = this.Connection;
            this._commandCollection[3].CommandText = "UPDATE       Tbl_Ogrenciler\r\nSET                OgrenciAd =@p1, OgrenciSoyad =@p2" +
                ", OgrenciKulup =@p3, OgrenciCinsiyet =@p4\r\nWHERE Ogrenciid=@p5";
            this._commandCollection[3].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[3].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@p1", global::System.Data.SqlDbType.VarChar, 30, global::System.Data.ParameterDirection.Input, 0, 0, "OgrenciAd", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[3].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@p2", global::System.Data.SqlDbType.VarChar, 30, global::System.Data.ParameterDirection.Input, 0, 0, "OgrenciSoyad", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, false)]
        public virtual int OgrenciGuncelle(string p1, string p2, global::System.Nullable<byte> p3, string p4, int p5) {
            global::System.Data.SqlClient.SqlCommand command = this.CommandCollection[3];
            if ((p1 == null)) {
                command.Parameters[0].Value = global::System.DBNull.Value;
            }
...
SELECT Notid, Dersid, Ogrenciid, Sinav1, Sinav2, Sinav3, Proje, Ortalama, Durum FROM Tbl_Notlar WHERE (Notid = @Notid)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT        Notid, Dersid, Ogrenciid, Sinav1, Sinav2, Sinav3, Proje, Ortalama, " +
                "Durum\r\nFROM            Tbl_Notlar\r\nWHERE        (Ogrenciid = @p1)";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[0].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@p1", global::System.Data.SqlDbType.Int, 4, global::System.Data.ParameterDirection.Input, 0, 0, "Ogrenciid", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, true)]
        public virtual int Fill(DataSet1.Tbl_NotlarDataTable dataTable, global::System.Nullable<int> p1) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((p1.HasValue == true)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, true)]
        public virtual DataSet1.Tbl_NotlarDataTable NotListesi(global::System.Nullable<int> p1) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((p1.HasValue == true)) {
                this.Adapter.SelectCommand.Parameters[0].Value = ((int)(p1.Value));
            }
